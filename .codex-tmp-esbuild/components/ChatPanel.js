...
var API_PREFIX = "/api/elevenlabs";
function sttModelId() {
  return import.meta.env.VITE_ELEVENLABS_STT_MODEL || "scribe_v2";
}
async function speechToText(audioBlob, fileName = "recording.webm") {
...
function ChatPanel({ messages, onSend, aiState, audioOnly = false, inputLocked = false }) {
  const [input, setInput] = (0, import_react24.useState)("");
  const [focused, setFocused] = (0, import_react24.useState)(false);
  const [recording, setRecording] = (0, import_react24.useState)(false);
  const [sttBusy, setSttBusy] = (0, import_react24.useState)(false);
  const [sttError, setSttError] = (0, import_react24.useState)("");
  const [bounce, setBounce] = (0, import_react24.useState)(false);
  const messagesEndRef = (0, import_react24.useRef)(null);
  const inputRef = (0, import_react24.useRef)(null);
  const mediaStreamRef = (0, import_react24.useRef)(null);
  const recorderRef = (0, import_react24.useRef)(null);
  const chunksRef = (0, import_react24.useRef)([]);
  const recordingStartedAtRef = (0, import_react24.useRef)(0);
  const visualizerCanvasRef = (0, import_react24.useRef)(null);
  const visualizerFrameRef = (0, import_react24.useRef)(0);
  const visualizerAudioContextRef = (0, import_react24.useRef)(null);
  const visualizerSourceRef = (0, import_react24.useRef)(null);
  const visualizerAnalyserRef = (0, import_react24.useRef)(null);
  const visualizerDataRef = (0, import_react24.useRef)(null);
  ...
  const clearVisualizer = (0, import_react24.useCallback)(() => {
  ...
  const stopVisualizer = (0, import_react24.useCallback)(() => {
    if (visualizerFrameRef.current) {
      window.cancelAnimationFrame(visualizerFrameRef.current);
  ...
  const stopMedia = (0, import_react24.useCallback)(() => {
    mediaStreamRef.current?.getTracks().forEach((t) => t.stop());
    mediaStreamRef.current = null;
    stopVisualizer();
  }, [stopVisualizer]);
  const startVisualizer = (0, import_react24.useCallback)(
    async (stream) => {
      stopVisualizer();
      const canvas = visualizerCanvasRef.current;
      if (!canvas) return;
  ...
  const startRecording = (0, import_react24.useCallback)(async () => {
    if (isDisabled || sttBusy) return;
    setSttError("");
    const mime = typeof MediaRecorder !== "undefined" && MediaRecorder.isTypeSupported("audio/webm;codecs=opus") ? "audio/webm;codecs=opus" : typeof MediaRecorder !== "undefined" && MediaRecorder.isTypeSupported("audio/webm") ? "audio/webm" : "";
  ...
  const finishRecording = (0, import_react24.useCallback)(async () => {
  ...
  const toggleMic = (0, import_react24.useCallback)(async () => {
    if (isDisabled || sttBusy) return;
    if (!recording) {
      try {
  ...
  const showTyping = aiState === "thinking" || aiState === "building" || aiState === "intake" || aiState === "topic" || aiState === "objectives" || aiState === "lesson_plan" || aiState === "gestures" || aiState === "visual_model";
  const handleSend = () => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    sttBusy ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: "32px", color: "black" } }, "\u2026") : /* @__PURE__ */ React.createElement("svg", { width: "36", height: "36", viewBox: "0 0 24 24", fill: "none", stroke: "black", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z" }), /* @__PURE__ */ React.createElement("path", { d: "M19 10v2a7 7 0 0 1-14 0v-2" }), /* @__PURE__ */ React.createElement("line", { x1: "12", x2: "12", y1: "19", y2: "22" }))
    ...
    /* @__PURE__ */ React.createElement("canvas", { ref: visualizerCanvasRef, className: "chat-visualizer-canvas", "aria-hidden": "true" })
  ), /* @__PURE__ */ React.createElement(
    motion.div,
    {
    ...
    !audioOnly && messages.length <= 1 && /* @__PURE__ */ React.createElement("div", { className: "suggestions" }, SUGGESTIONS.map((s) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: s,
    ...
    /* @__PURE__ */ React.createElement("div", { className: "chat-messages" }, /* @__PURE__ */ React.createElement(AnimatePresence, { initial: false }, messages.map((msg) => /* @__PURE__ */ React.createElement(
      motion.div,
      {
        key: msg.id,
      ...
      msg.from === "ai" && /* @__PURE__ */ React.createElement("span", { className: "bubble-avatar" }, "\u{1F916}"),
      /* @__PURE__ */ React.createElement("span", null, msg.text)
    ))), /* @__PURE__ */ React.createElement(AnimatePresence, null, showTyping && /* @__PURE__ */ React.createElement(
      motion.div,
      {
      ...
      /* @__PURE__ */ React.createElement("span", { className: "bubble-avatar" }, "\u{1F916}"),
      /* @__PURE__ */ React.createElement("span", { className: "typing-dots" }, /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("span", null))
    )), /* @__PURE__ */ React.createElement("div", { ref: messagesEndRef })),
    !audioOnly && /* @__PURE__ */ React.createElement("div", { className: "chat-input-row" }, /* @__PURE__ */ React.createElement(
      motion.button,
      {
        type: "button",
    ...
    audioOnly && /* @__PURE__ */ React.createElement("div", { className: "chat-inline-error" }, "Use the mic for every answer."),
    sttError && /* @__PURE__ */ React.createElement("div", { className: "chat-inline-error" }, sttError)
  ));
}
export {
