 ...
 *  audioLevelsRef          - ref to latest TTS analyser buckets (ElevenLabs playAudioBlob)
 *  audioActive             - whether speech is driving the level meter
 *  visualization           - optional math visualization payload (from lesson pipeline)
...
/** TTS level meters in world space — slightly past the character toward the camera plane. */
