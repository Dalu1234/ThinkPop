...
// src/components/CountingToolPanel.jsx
...
function CountingToolPanel({
  ...
  const dots = (0, import_react24.useMemo)(() => buildDots(totalDots), [totalDots]);
  const ready = totalDots > 0;
  return /* @__PURE__ */ React.createElement(AnimatePresence, null, visible && /* @__PURE__ */ React.createElement(
    motion.div,
    {
    ...
    /* @__PURE__ */ React.createElement("div", { className: "counting-tool-card" }, /* @__PURE__ */ React.createElement("div", { className: "counting-tool-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "counting-tool-kicker" }, kicker), /* @__PURE__ */ React.createElement("h2", { className: "counting-tool-title" }, title)), /* @__PURE__ */ React.createElement("div", { className: "counting-tool-status" }, /* @__PURE__ */ React.createElement("span", { className: "counting-tool-status-label" }, "Added"), /* @__PURE__ */ React.createElement("span", { className: "counting-tool-status-value" }, ready ? `+${lastAdded}` : "Ready"))), /* @__PURE__ */ React.createElement("p", { className: "counting-tool-copy" }, "The dots build one at a time first, then the tutor adds a small group and asks for the total."), /* @__PURE__ */ React.createElement("div", { className: "counting-tool-stage" }, /* @__PURE__ */ React.createElement(AnimatePresence, { mode: "popLayout" }, dots.map((dot) => /* @__PURE__ */ React.createElement(
      motion.span,
      {
        key: dot,
    ...
    ))), !ready && /* @__PURE__ */ React.createElement("div", { className: "counting-tool-empty" }, "Ask to practice counting, then watch the dots appear.")), /* @__PURE__ */ React.createElement("div", { className: "counting-tool-footer" }, /* @__PURE__ */ React.createElement("p", { className: "counting-tool-prompt" }, prompt)))
  ));
}
export {
  CountingToolPanel as default
};
